...
BRIEF_PROMPT_TEMPLATE = """Tu es un strategiste SEO et GEO (Generative Engine Optimization) specialise en niche : skincare ingredients, routine building, product rating (acids, retinol, SPF, actives).
...
REQUETE : "{keyword}"
MARCHE CIBLE : EN international + FR, skincare enthusiasts researching ingredients and product quality
NOTRE POSITIONNEMENT : SkinScore, comparateur skincare A-E, independent formulation analysis, 2700+ products scored
