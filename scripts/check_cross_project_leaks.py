...
SELF_PROJECT = {
    "name": 'getskinscore',
    "supabase_ref": 'ovptmntzrrrjxstzzceu',
    "domain": 'getskinscore.com',
    "cf_pages_project": 'getskinscore',
    "own_tokens": {'SkinScore', 'getskinscore', 'getskinscore.com'},
    "own_domains": {'getskinscore.com'},
    "own_supabase_refs": {'ovptmntzrrrjxstzzceu'},
}
