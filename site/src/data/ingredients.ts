...
export const ingredients: Ingredient[] = [
  ...
  // ===========================
  {
    ...
    description: {
      ...
      fr: "Derive de la vitamine A et reference absolue en anti-age. Stimule le renouvellement cellulaire, la production de collagene et réduit rides, ridules et hyperpigmentation. Des decennies de preuves cliniques."
    },
    benefits: {
      en: "Reduces wrinkles, fades dark spots, improves skin texture, treats acne, boosts collagen",
      fr: "Réduit les rides, attenue les taches, ameliore la texture, traite l'acne, stimule le collagene"
    },
    risks: {
  ...
  },
  {
    ...
    description: {
      ...
      fr: "Derive de la vitamine B3, l'un des actifs les plus polyvalents. Renforce la barriere cutanee, resserre les pores, contrôle le sebum, attenue les taches et possede des proprietes anti-inflammatoires. Bien tolere par tous les types de peau."
    },
    benefits: {
      en: "Reduces pores, controls oil, fades hyperpigmentation, strengthens barrier, anti-inflammatory",
      fr: "Resserre les pores, contrôle le sebum, attenue l'hyperpigmentation, renforce la barriere, anti-inflammatoire"
    },
    risks: {
  ...
  },
  {
    ...
    benefits: {
      ...
      fr: "Desincruste les pores, réduit l'acne, contrôle le sebum, exfoliation douce, anti-inflammatoire"
    },
    risks: {
  ...
  },
  {
    ...
    risks: {
      ...
      fr: "Leger picotement ou demangeaison aux premiers usages. Généralement tres bien tolere."
    },
  ...
  },
  {
    ...
    risks: {
      ...
      fr: "Aucun risque connu. L'un des ingredients les plus surs et bénéfiques en skincare."
    },
  ...
  // ===========================
  {
    ...
    risks: { en: "Can leave white cast on darker skin tones. Nano-zinc reduces this but raises inhalation concerns in sprays.", fr: "Peut laisser un film blanc sur peaux foncees. Le nano-zinc réduit cet effet mais pose des questions en spray." },
  ...
  },
  {
    ...
    description: {
      ...
      fr: "Tensioactif anionique agressif utilise dans les nettoyants. Mousse abondante mais altere la barriere cutanee. L'un des irritants les plus etudies en dermatologie (contrôle positif en patch tests)."
    },
  ...
  },
  {
    ...
    description: {
      ...
      fr: "Filtre UV chimique a large spectre mais avec des preoccupations de sécurité majeures. Perturbateur endocrinien, risque de photoallergie et nocif pour les recifs coralliens. Interdit a Hawaii et Palau."
    },
  ...
  },
  {
    ...
    description: {
      ...
      fr: "Conservateur nomme 'Allergène de l'annee' en 2013. Sensibilisant puissant qui a provoque une epidemie de dermatite de contact. Interdit dans les produits sans rincage en UE, restreint en rincage."
    },
  ...
  },
  {
    ...
    description: {
      ...
      fr: "Alternative végétale au retinol issue de la plante Babchi. Imite les effets anti-age du retinol (stimulation du collagene, renouvellement cellulaire) sans l'irritation. Compatible grossesse."
    },
  ...
  },
  {
    ...
    benefits: { en: "Fades melasma, reduces dark spots, prevents UV-induced pigmentation, well-tolerated", fr: "Attenue le melasma, réduit les taches, previent la pigmentation UV, bien tolere" },
  ...
  },
  {
    ...
    description: {
      ...
      fr: "Alternative d'origine végétale au propylene glycol. Humectant et solvant qui ameliore l'absorption des actifs. Bio-source, durable et tres doux pour la peau.",
    },
    benefits: { en: "Humectant, enhances absorption, plant-derived, gentle", fr: "Humectant, ameliore l'absorption, d'origine végétale, doux" },
  ...
  },
  {
    ...
    description: {
      ...
      fr: "Un ajusteur de pH (soude) utilise en infimes quantites pour amener les formules a un pH compatible avec la peau. Malgre son nom, complètement sur aux traces utilisees en cosmetique. Essentiel pour les produits AHA/BHA.",
    },
  ...
  },
  {
    ...
    description: {
      ...
      fr: "Un agent chelateur qui se lie aux ions metalliques dans l'eau, empechant la destabilisation de la formule. Ameliore l'efficacite des conservateurs. Tres courant, généralement sur.",
    },
  ...
  },
  {
    ...
    description: {
      ...
      fr: "Techniquement une cire liquide, pas une huile. Imite etroitement le sebum humain, ce qui en fait l'une des huiles végétales les plus compatibles avec la peau. Equilibre la production de sebum.",
    },
  ...
  },
  {
    ...
    description: {
      ...
      fr: "Une huile faciale seche et legere riche en omega-3, omega-6 et vitamine A (retinoides). L'une des rares huiles végétales avec des preuves cliniques pour ameliorer cicatrices, hyperpigmentation et elasticite.",
    },
  ...
  },
  {
    ...
    description: {
      ...
      fr: "Un antioxydant d'origine végétale qui double le pouvoir photoprotecteur des vitamines C et E en combinaison. Le troisieme ingredient du celebre combo C+E+Ferulique (brevet SkinCeuticals). Stabilise la vitamine C.",
    },
  ...
  },
  {
    ...
    description: {
      ...
      fr: "Sel de zinc de l'acide pyrrolidone carboxylique. Contrôle la production de sebum, possede des proprietes antimicrobiennes et soutient la cicatrisation. Ingredient cle des formulations anti-acne.",
    },
  ...
  },
  {
    ...
    description: {
      ...
      fr: "Un humectant synthetique et amplificateur de penetration. Efficace mais peut irriter les peaux sensibles. Remplace par le propanediol (alternative végétale) dans de nombreuses formulations modernes.",
    },
    ...
    risks: { en: "Can irritate sensitive skin. Mild allergen for some (rare). Being phased out in favour of propanediol.", fr: "Peut irriter les peaux sensibles. Allergène leger pour certains (rare). Progressivement remplace par le propanediol." },
    concerns: [],
    goodFor: ["normal", "oily", "combination"],
    badFor: ["sensitive"],
    euRestricted: false,
  ...
  // ===========================
  { id: "ethylhexyl-triazone", inciName: "Ethylhexyl Triazone", name: { en: "Ethylhexyl Triazone (Uvinul T150)", fr: "Ethylhexyl Triazone (Uvinul T150)" }, category: "sunscreen", score: "A", color: "green", comedogenic: 0, description: { en: "A highly photostable UVB filter used primarily in European sunscreens. Very efficient at low concentrations. Does not degrade in sunlight like older filters.", fr: "Un filtre UVB hautement photostable utilise principalement dans les cremes solaires europeennes. Tres efficace a faible concentration. Ne se degrade pas au soleil." }, benefits: { en: "Photostable UVB protection, efficient at low %, modern filter", fr: "Protection UVB photostable, efficace a faible %, filtre moderne" }, risks: { en: "None at cosmetic concentrations.", fr: "Aucun aux concentrations cosmetiques." }, concerns: [], goodFor: ["dry", "oily", "combination", "sensitive", "normal"], badFor: [], euRestricted: false, casNumber: "88122-99-0" },
  { id: "bis-ethylhexyloxyphenol-methoxyphenyl-triazine", inciName: "Bis-Ethylhexyloxyphenol Methoxyphenyl Triazine", name: { en: "Tinosorb S", fr: "Tinosorb S" }, category: "sunscreen", score: "A", color: "green", comedogenic: 0, description: { en: "A broad-spectrum UV filter (UVA + UVB) developed by BASF. One of the most photostable modern filters. Stabilises other UV filters in the formula. EU-approved, not yet FDA-approved.", fr: "Un filtre UV large spectre (UVA + UVB) developpe par BASF. L'un des filtres modernes les plus photostables. Stabilise les autres filtres UV. Approuve UE, pas encore approuve FDA." }, benefits: { en: "Broad-spectrum UVA+UVB, photostable, stabilises other filters", fr: "Large spectre UVA+UVB, photostable, stabilise les autres filtres" }, risks: { en: "None. One of the safest modern UV filters.", fr: "Aucun. L'un des filtres UV modernes les plus surs." }, concerns: [], goodFor: ["dry", "oily", "combination", "sensitive", "normal"], badFor: [], euRestricted: false, casNumber: "187393-00-6", aliases: ["tinosorb s"] },
  { id: "diethylamino-hydroxybenzoyl-hexyl-benzoate", inciName: "Diethylamino Hydroxybenzoyl Hexyl Benzoate", name: { en: "Mexoryl 400 (DHHB)", fr: "Mexoryl 400 (DHHB)" }, category: "sunscreen", score: "A", color: "green", comedogenic: 0, description: { en: "The newest generation UVA filter by L'Oreal. Protects against ultra-long UVA rays (UVA1) that penetrate deep into skin. Used in La Roche-Posay Anthelios UVMune 400.", fr: "Le filtre UVA de derniere generation de L'Oreal. Protege contre les UVA ultra-longs (UVA1) qui penetrent profondement. Utilise dans La Roche-Posay Anthelios UVMune 400." }, benefits: { en: "Ultra-long UVA1 protection, newest generation, patented by L'Oreal", fr: "Protection UVA1 ultra-longs, derniere generation, brevete par L'Oreal" }, risks: { en: "None known. Very new (limited long-term data, but no concerns raised).", fr: "Aucun connu. Tres recent (donnees long terme limitees, mais aucune preoccupation)." }, concerns: [], goodFor: ["dry", "oily", "combination", "sensitive", "normal"], badFor: [], euRestricted: false, casNumber: "302776-68-7", aliases: ["mexoryl 400", "dhhb", "uvmune 400"] },
  { id: "octinoxate", inciName: "Ethylhexyl Methoxycinnamate", name: { en: "Octinoxate", fr: "Octinoxate" }, category: "sunscreen", score: "D", color: "orange", comedogenic: 0, description: { en: "A chemical UVB filter with endocrine disruption concerns. Banned in Hawaii and Palau for coral reef damage. Being phased out in favour of newer, safer filters.", fr: "Un filtre UVB chimique avec des preoccupations de perturbation endocrinienne. Interdit a Hawaii et Palau pour les dommages aux recifs. Progressivement remplace par des filtres plus surs." }, benefits: { en: "UVB protection, lightweight, cosmetically elegant", fr: "Protection UVB, leger, cosmetiquement elegant" }, risks: { en: "Endocrine disruptor (estrogenic). Coral reef damage. Photo-unstable. Banned in Hawaii/Palau.", fr: "Perturbateur endocrinien (estrogenique). Dommages aux recifs. Photo-instable. Interdit a Hawaii/Palau." }, concerns: [], goodFor: [], badFor: ["sensitive"], euRestricted: true, casNumber: "5466-77-3", aliases: ["ethylhexyl methoxycinnamate", "omi", "parsol mcx"] },
  { id: "galactomyces-ferment-filtrate", inciName: "Galactomyces Ferment Filtrate", name: { en: "Galactomyces Ferment Filtrate", fr: "Filtrat de fermentation de Galactomyces" }, category: "active", score: "B", color: "green", comedogenic: 0, description: { en: "A yeast ferment filtrate similar to SK-II's Pitera. Rich in amino acids, vitamins, and organic acids. Brightens, hydrates, and improves skin texture. Popular in Missha First Treatment Essence.", fr: "Un filtrat de ferment de levure similaire au Pitera de SK-II. Riche en acides amines, vitamines et acides organiques. Illumine, hydrate et ameliore la texture. Populaire dans Missha First Treatment." }, benefits: { en: "Brightening, hydrating, rich in nutrients, improves texture", fr: "Eclat, hydratation, riche en nutriments, ameliore la texture" }, risks: { en: "May worsen fungal acne (yeast-derived). Otherwise safe.", fr: "Peut aggraver l'acne fongique (derive de levure). Sinon sur." }, concerns: ["anti-aging", "dryness"], goodFor: ["dry", "normal", "combination"], badFor: [], euRestricted: false },
  { id: "calamine", inciName: "Calamine", name: { en: "Calamine", fr: "Calamine" }, category: "soothing", score: "A", color: "green", comedogenic: 0, description: { en: "A classic anti-itch and soothing mineral (zinc oxide + iron oxide). Used in Mario Badescu Drying Lotion and calamine lotions. Dries out pimples and reduces redness.", fr: "Un mineral classique anti-demangeaisons et apaisant (oxyde de zinc + oxyde de fer). Utilise dans le Drying Lotion de Mario Badescu. Asseche les boutons et réduit les rougeurs." }, benefits: { en: "Anti-itch, soothing, dries pimples, reduces redness", fr: "Anti-demangeaisons, apaisant, asseche les boutons, réduit les rougeurs" }, risks: { en: "Can be drying. For spot treatment, not full-face.", fr: "Peut dessecher. Pour traitement localise, pas plein visage." }, concerns: ["acne"], goodFor: ["oily", "combination"], badFor: ["dry"], euRestricted: false, casNumber: "8011-96-9" },
  { id: "sulfur", inciName: "Sulfur", name: { en: "Sulfur", fr: "Soufre" }, category: "active", score: "B", color: "yellow", comedogenic: 0, description: { en: "An ancient anti-acne ingredient with antibacterial, antifungal, and keratolytic properties. Still used in Mario Badescu Drying Lotion and De La Cruz Sulfur Ointment. Less irritating than benzoyl peroxide.", fr: "Un ingredient anti-acne ancestral aux proprietes antibacteriennes, antifongiques et keratolytiques. Encore utilise dans le Drying Lotion Mario Badescu. Moins irritant que le peroxyde de benzoyle." }, benefits: { en: "Antibacterial, antifungal, keratolytic, less irritating than BP", fr: "Antibacterien, antifongique, keratolytique, moins irritant que le PB" }, risks: { en: "Drying. Strong smell. Can bleach fabrics.", fr: "Dessechant. Odeur forte. Peut decolorer les tissus." }, concerns: ["acne"], goodFor: ["oily", "combination"], badFor: ["dry", "sensitive"], euRestricted: false, casNumber: "7704-34-9" },
  { id: "walnut-shell-powder", inciName: "Juglans Regia Shell Powder", name: { en: "Walnut Shell Powder", fr: "Poudre de coque de noix" }, category: "exfoliant", score: "E", color: "red", comedogenic: 0, description: { en: "A physical exfoliant with jagged, irregular particles that create micro-tears in skin. The controversial ingredient in St. Ives Apricot Scrub. Dermatologists unanimously recommend against it.", fr: "Un exfoliant physique aux particules irregulieres et coupantes qui creent des micro-dechirures. L'ingredient controverse du gommage St. Ives. Les dermatologues le deconseillent unanimement." }, benefits: { en: "Physical exfoliation (but chemical exfoliants are safer)", fr: "Exfoliation physique (mais les exfoliants chimiques sont plus surs)" }, risks: { en: "Causes micro-tears in skin. Irregular sharp particles damage skin barrier. Class action lawsuit against St. Ives. Use AHAs/BHAs instead.", fr: "Cause des micro-dechirures. Particules irregulieres et coupantes endommagent la barriere. Proces contre St. Ives. Utiliser des AHA/BHA a la place." }, concerns: [], goodFor: [], badFor: ["dry", "oily", "combination", "sensitive", "normal"], euRestricted: false, casNumber: "12000-95-8", aliases: ["juglans regia", "walnut shell"] },
  { id: "algae-extract", inciName: "Algae Extract", name: { en: "Algae Extract (Seaweed)", fr: "Extrait d'algue" }, category: "hydrator", score: "B", color: "green", comedogenic: 4, description: { en: "A broad category of marine extracts used in many luxury products (La Mer uses a specific algae ferment). Rich in minerals, amino acids, and antioxidants. Highly comedogenic (4/5).", fr: "Large catégorie d'extraits marins utilises dans de nombreux produits de luxe (La Mer utilise un ferment d'algue spécifique). Riche en mineraux, acides amines et antioxydants. Hautement comedogene (4/5)." }, benefits: { en: "Rich in minerals, antioxidant, hydrating, anti-inflammatory", fr: "Riche en mineraux, antioxydant, hydratant, anti-inflammatoire" }, risks: { en: "Highly comedogenic (4/5). Can trigger breakouts on acne-prone skin.", fr: "Hautement comedogene (4/5). Peut declencher des eruptions sur peau acneique." }, concerns: ["anti-aging", "dryness"], goodFor: ["dry", "normal"], badFor: ["oily", "combination"], euRestricted: false, aliases: ["seaweed", "kelp", "marine extract"] },
  { id: "ginseng-extract", inciName: "Panax Ginseng Root Extract", name: { en: "Ginseng Extract", fr: "Extrait de ginseng" }, category: "botanical", score: "A", color: "green", comedogenic: 0, description: { en: "Traditional Asian medicinal root with proven anti-aging, antioxidant, and skin-brightening properties. The star ingredient in Sulwhasoo's luxury line. Contains ginsenosides.", fr: "Racine medicinale asiatique traditionnelle aux proprietes anti-age, antioxydantes et eclaircissantes prouvees. L'ingredient star de la gamme luxe Sulwhasoo. Contient des ginsenosides." }, benefits: { en: "Anti-aging, antioxidant, brightening, energising, collagen stimulation", fr: "Anti-age, antioxydant, eclaircissant, energisant, stimulation du collagene" }, risks: { en: "None at cosmetic concentrations.", fr: "Aucun aux concentrations cosmetiques." }, concerns: ["anti-aging"], goodFor: ["dry", "normal", "combination"], badFor: [], euRestricted: false, casNumber: "50647-08-0", aliases: ["panax ginseng", "korean ginseng", "red ginseng"] },
  { id: "caviar-extract", inciName: "Caviar Extract", name: { en: "Caviar Extract", fr: "Extrait de caviar" }, category: "active", score: "B", color: "green", comedogenic: 0, description: { en: "Luxury ingredient rich in omega-3, phospholipids, amino acids, and minerals. Used in La Prairie's Skin Caviar line. Nourishing but very expensive with limited clinical evidence vs cheaper actives.", fr: "Ingredient de luxe riche en omega-3, phospholipides, acides amines et mineraux. Utilise dans la gamme Skin Caviar de La Prairie. Nourrissant mais tres cher avec des preuves cliniques limitees." }, benefits: { en: "Rich in omega-3, phospholipids, amino acids, nourishing", fr: "Riche en omega-3, phospholipides, acides amines, nourrissant" }, risks: { en: "None. But very expensive with limited evidence that it works better than simpler ingredients.", fr: "Aucun. Mais tres cher avec des preuves limitees qu'il fonctionne mieux que des ingredients plus simples." }, concerns: ["anti-aging", "dryness"], goodFor: ["dry", "normal"], badFor: [], euRestricted: false },
  { id: "gold", inciName: "Gold", name: { en: "Colloidal Gold", fr: "Or colloidal" }, category: "active", score: "C", color: "yellow", comedogenic: 0, description: { en: "Used in luxury products (Tatcha, La Prairie) for anti-inflammatory and antioxidant properties. Very limited clinical evidence for topical gold in skincare. Mostly a marketing ingredient.", fr: "Utilise dans les produits de luxe (Tatcha, La Prairie) pour ses proprietes anti-inflammatoires et antioxydantes. Preuves cliniques tres limitees pour l'or topique. Principalement un ingredient marketing." }, benefits: { en: "Anti-inflammatory (limited evidence), antioxidant, luxury positioning", fr: "Anti-inflammatoire (preuves limitees), antioxydant, positionnement luxe" }, risks: { en: "No risks but very limited evidence it does anything meaningful topically.", fr: "Aucun risque mais preuves tres limitees d'un effet significatif en topique." }, concerns: [], goodFor: ["normal"], badFor: [], euRestricted: false, casNumber: "7440-57-5" },
];
