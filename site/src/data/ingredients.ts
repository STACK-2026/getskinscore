...
export const ingredients: Ingredient[] = [
  ...
  { id: "calamine", inciName: "Calamine", name: { en: "Calamine", fr: "Calamine" }, category: "soothing", score: "A", color: "green", comedogenic: 0, description: { en: "A classic anti-itch and soothing mineral (zinc oxide + iron oxide). Used in Mario Badescu Drying Lotion and calamine lotions. Dries out pimples and reduces redness.", fr: "Un mineral classique anti-demangeaisons et apaisant (oxyde de zinc + oxyde de fer). Utilise dans le Drying Lotion de Mario Badescu. Asseche les boutons et reduit les rougeurs." }, benefits: { en: "Anti-itch, soothing, dries pimples, reduces redness", fr: "Anti-demangeaisons, apaisant, asseche les boutons, reduit les rougeurs" }, risks: { en: "Can be drying. For spot treatment, not full-face.", fr: "Peut dessecher. Pour traitement localise, pas plein visage." }, concerns: ["acne"], goodFor: ["oily", "combination"], badFor: ["dry"], euRestricted: false, casNumber: "8011-96-9" },
