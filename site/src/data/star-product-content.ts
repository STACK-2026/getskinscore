...
// ===========================
  ...
  // AUGUSTINUS BADER THE RICH CREAM
  {
    ...
    editorialReview: { en: "If La Mer is luxury marketing with mediocre ingredients, Augustinus Bader is the opposite: genuine science wrapped in luxury packaging. Professor Augustinus Bader spent 30 years researching wound healing at Leipzig University before creating TFC8 - a blend of amino acids, vitamins, and synthesized molecules designed to activate your skin's own stem cells. No fragrance, no essential oils, no known irritants. It scores A (87/100) because it actually delivers proven actives in a clean vehicle. Is it worth 235 EUR for 50ml? Debatable. But unlike La Mer, the science behind the price tag is real and published.", fr: "Si La Mer c'est du marketing de luxe avec des ingredients mediocres, Augustinus Bader est l'inverse : de la vraie science dans un packaging luxe. Le Professeur Bader a passe 30 ans a rechercher la cicatrisation a l'Universite de Leipzig avant de creer le TFC8. Sans parfum, sans huiles essentielles, sans irritants connus. Il obtient A (87/100) parce qu'il delivre vraiment des actifs prouves. Vaut-il 235 EUR les 50ml ? Discutable. Mais contrairement a La Mer, la science derriere le prix est reelle et publiee." },
    howToUse: { en: "Apply a pearl-sized amount to clean skin AM and PM. No warming ritual needed. Can be used over retinol and vitamin C. Works as both moisturiser and treatment.", fr: "Applique une quantite de la taille d'une perle sur peau propre matin et soir. Pas de rituel de rechauffement. Compatible avec retinol et vitamine C." },
    whoIsItFor: { en: "Best for: anyone wanting luxury skincare backed by science. Anti-aging, dry/mature skin. Less ideal for: anyone on a budget (CeraVe + retinol = similar results at 1/10th).", fr: "Ideal pour : skincare luxe avec vraie science derriere. Anti-age, peau seche/mature. Moins adapte pour : petits budgets (CeraVe + retinol = resultats similaires a 1/10e)." },
    whatToExpect: { en: "Week 1-2: more hydrated, plumper skin. Month 1-2: improved texture, subtle glow. Month 3+: visible fine lines improvement. TFC8 works on cell renewal, results are cumulative.", fr: "Semaine 1-2 : peau plus hydratee, repulpee. Mois 1-2 : texture amelioree, eclat subtil. Mois 3+ : amelioration visible des ridules. Le TFC8 agit sur le renouvellement cellulaire, les resultats sont cumulatifs." },
    commonMistakes: { en: "1. Comparing to La Mer (different philosophy). 2. Expecting instant miracles (works over months). 3. Not considering CeraVe + retinol at 1/10th the price.", fr: "1. Comparer a La Mer (philosophie differente). 2. Attendre des miracles instantanes (fonctionne sur des mois). 3. Ne pas considerer CeraVe + retinol a 1/10e du prix." },
    faq: [{ question: { en: "Augustinus Bader vs La Mer?", fr: "Augustinus Bader vs La Mer ?" }, answer: { en: "AB scores A (87), La Mer scores C (67). AB has published research, no fragrance. La Mer has mineral oil, fragrance, no published trials. If spending luxury money, AB is objectively better.", fr: "AB obtient A (87), La Mer obtient C (67). AB a de la recherche publiee, sans parfum. La Mer a huile minerale, parfum, aucun essai publie. Si tu depenses du luxe, AB est objectivement meilleur." } }],
    vsCompetitors: [{ competitorId: "la-mer-creme-de-la-mer", competitorName: "La Mer", verdict: { en: "AB A (87) vs La Mer C (67). Published science vs marketing narrative. No fragrance vs fragrance. If buying luxury, buy the science.", fr: "AB A (87) vs La Mer C (67). Science publiee vs narrative marketing. Sans parfum vs parfum. Si tu achetes du luxe, achete la science." } }],
  },

  // CERAVE PM FACIAL MOISTURIZING LOTION
  {
    id: "cerave-pm-facial-moisturizing-lotion",
    editorialReview: { en: "The viral TikTok moisturiser dermatologists actually agree with. CeraVe PM is the same ceramide formula as the tub but in lightweight lotion - better for oily/combination skin. 4% niacinamide (optimal per studies), three ceramides, hyaluronic acid. No fragrance. The 'PM' name is misleading - use it AM and PM. At 14 EUR, it's the best niacinamide moisturiser without prescription.", fr: "L'hydratant viral TikTok sur lequel les dermatologues sont d'accord. CeraVe PM est la meme formule aux ceramides que le pot mais en lotion legere - meilleure pour peau grasse/mixte. 4% niacinamide (optimal selon les etudes), trois ceramides, acide hyaluronique. Sans parfum. Le nom 'PM' est trompeur - utilise-le matin ET soir." },
    howToUse: { en: "Apply a dime-sized amount after serums, AM and PM. Light enough to layer under SPF. Pairs perfectly with retinol (retinol first, wait 5min, then CeraVe PM).", fr: "Applique une quantite de la taille d'une piece apres les serums, matin et soir. Assez leger pour se superposer sous un SPF. Parfait avec le retinol." },
    whoIsItFor: { en: "Best for: oily, combination, acne-prone skin. Retinol users. Less ideal for: very dry skin in winter.", fr: "Ideal pour : peau grasse, mixte, acneique. Utilisateurs de retinol. Moins adapte pour : peau tres seche en hiver." },
    whatToExpect: { en: "Immediate: lightweight hydration. Week 2-4: reduced oiliness, calmer skin. Month 1-2: stronger barrier, fewer breakouts.", fr: "Immediat : hydratation legere. Semaine 2-4 : sebum reduit, peau plus calme. Mois 1-2 : barriere plus forte, moins d'eruptions." },
    commonMistakes: { en: "1. Only using at night. 2. Layering extra niacinamide on top (PM already has 4%). 3. Using instead of tub on very dry skin.", fr: "1. Utiliser uniquement le soir. 2. Superposer du niacinamide supplementaire (PM a deja 4%). 3. Utiliser a la place du pot sur peau tres seche." },
    faq: [{ question: { en: "PM vs Tub?", fr: "PM vs Pot ?" }, answer: { en: "Same ceramides, different texture. PM = light, 4% niacinamide, best for oily skin. Tub = rich, less niacinamide, best for dry skin.", fr: "Memes ceramides, texture differente. PM = leger, 4% niacinamide, meilleur peau grasse. Pot = riche, moins de niacinamide, meilleur peau seche." } }],
    vsCompetitors: [{ competitorId: "cerave-moisturizing-cream", competitorName: "CeraVe Tub", verdict: { en: "Same family. PM A (86) lighter with more niacinamide. Tub A (88) richer. Oily = PM. Dry = Tub.", fr: "Meme famille. PM A (86) plus leger avec plus de niacinamide. Pot A (88) plus riche. Grasse = PM. Seche = Pot." } }],
  },

  // BIODERMA SENSIBIO H2O
  {
    id: "bioderma-sensibio-h2o",
    editorialReview: { en: "The micellar water that started a revolution. Before Sensibio H2O, removing makeup required harsh toners. Bioderma used micelles to dissolve makeup without rubbing, rinsing, or irritation. #1 selling product in French pharmacies. Backstage must-have at Fashion Week. No fragrance, no alcohol, no soap. The D.A.F. patent mimics your skin's natural composition. It cannot irritate. Limitation: no active ingredients. It removes stuff, it doesn't treat anything.", fr: "L'eau micellaire qui a lance une revolution. Avant Sensibio H2O, demaquiller necessitait des toniques agressifs. Bioderma a utilise des micelles pour dissoudre le maquillage sans frotter, rincer ou irriter. Produit n1 en pharmacie francaise. Indispensable backstage Fashion Week. Sans parfum, sans alcool, sans savon. Le brevet D.A.F. imite la composition naturelle de ta peau. Il ne PEUT pas irriter. Limite : aucun actif. Il enleve, il ne traite rien." },
    howToUse: { en: "Soak cotton pad, PRESS (don't rub) on closed eyes 10 seconds. Sweep gently across face. No rinse needed. First step of double cleansing.", fr: "Imbibe un coton, PRESSE (ne frotte pas) sur yeux fermes 10 secondes. Passe doucement sur le visage. Pas de rincage. Premiere etape du double nettoyage." },
    whoIsItFor: { en: "Best for: sensitive skin, makeup removal, post-procedure, babies. Less ideal for: heavy waterproof makeup alone.", fr: "Ideal pour : peau sensible, demaquillage, post-acte, bebes. Moins adapte pour : maquillage waterproof lourd seul." },
    whatToExpect: { en: "Instant clean skin without tightness. It's a cleanser, not a treatment.", fr: "Peau propre instantanement sans tiraillement. C'est un nettoyant, pas un traitement." },
    commonMistakes: { en: "1. Rubbing instead of pressing. 2. Expecting it to remove heavy waterproof mascara alone. 3. Comparing to Garnier (Bioderma has no fragrance or PHMB).", fr: "1. Frotter au lieu de presser. 2. S'attendre a ce qu'il enleve seul le mascara waterproof. 3. Comparer a Garnier (Bioderma n'a ni parfum ni PHMB)." },
    faq: [{ question: { en: "Bioderma vs Garnier Micellar?", fr: "Bioderma vs Garnier Micellaire ?" }, answer: { en: "Bioderma B (74), Garnier C (62). Garnier has fragrance + PHMB (EU-restricted). Bioderma has neither. For sensitive skin, always Bioderma.", fr: "Bioderma B (74), Garnier C (62). Garnier contient parfum + PHMB (reglemente UE). Bioderma n'a ni l'un ni l'autre. Pour peau sensible, toujours Bioderma." } }],
    vsCompetitors: [{ competitorId: "garnier-skinactive-micellar-cleansing-water-all-in-1", competitorName: "Garnier Micellar", verdict: { en: "Bioderma B vs Garnier C. No fragrance vs fragrance. No PHMB vs PHMB. Bioderma costs 2x more but is genuinely gentler.", fr: "Bioderma B vs Garnier C. Sans parfum vs parfum. Sans PHMB vs PHMB. Bioderma coute 2x plus mais est vraiment plus doux." } }],
  },
];
