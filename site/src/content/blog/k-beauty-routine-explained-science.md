...
author: "lina-park"
category: "routines"
tags: ["k-beauty", "korean skincare", "10 step routine", "glass skin", "snail mucin", "centella asiatica", "double cleansing"]
keywords: "k-beauty routine, korean skincare routine, 10 step korean skincare, k-beauty science, glass skin, snail mucin, centella asiatica"
draft: false
image: "https://images.unsplash.com/photo-1556228720-195a672e8a03?w=1200&h=630&fit=crop&crop=center&q=80"
imageAlt: "Lineup of Korean skincare bottles and a sheet mask on a clean light surface"
lang: "en"
lastReviewed: "2026-05-21"
reviewedBy: "SkinScore Research Team"
schemaFaq: true
speakableTerm: "k-beauty routine"
speakable: "The K-beauty routine is built on four scientifically supported steps: oil cleanser to dissolve sunscreen and sebum, water cleanser to remove residue, moisturizer to support the skin barrier, and SPF in the morning. The famous 10 step version layers six optional products (toner, essence, serum, ampoule, sheet mask, eye cream) to deepen hydration and target specific concerns. Glass skin comes from consistent humectant layering, not from owning every step. Key ingredients with peer reviewed evidence include centella asiatica, niacinamide, hyaluronic acid and panthenol."
---
...
1. **Oil based cleanser** to dissolve sunscreen, sebum and makeup. Cleansing oils, balms or sherbets.
2. **Water based cleanser** to remove residue and water soluble debris. Foams, gels or low pH cleansers.
3. **Moisturizer** to seal water in and supply barrier lipids. Creams, gels, emulsions or sleeping packs.
4. **Sunscreen** in the morning, ideally SPF 50, broad spectrum.

These four steps cover everything a dermatologist would ask you to do at minimum. Double cleansing is supported by a 2019 publication on [PubMed](https://pubmed.ncbi.nlm.nih.gov/30729662/) showing improved removal of long-wear cosmetics and oil soluble sunscreen residues compared to single cleansing, without measurable barrier disruption when surfactants are mild. Daily SPF is the single most evidence backed cosmetic intervention against photoaging and skin cancer, a position the [AAD](https://www.aad.org/public/everyday-care/sun-protection) and the French [HAS](https://www.has-sante.fr) both reinforce. For a deeper SPF discussion, see our [best sunscreen for oily skin](/blog/best-sunscreen-oily-skin-no-white-cast/) guide.
...
**Centella asiatica (Cica).** Also known as gotu kola or tiger grass. The active compounds are madecassoside, asiaticoside and madecassic acid. A 2018 randomized study referenced on [PubMed](https://pubmed.ncbi.nlm.nih.gov/29193146/) confirms anti-inflammatory and wound healing effects. Cica is now a default ingredient in COSRX, Dr. Jart+ and Skin1004 lineups for sensitized, post-procedure or post-acne skin.

**Snail secretion filtrate (snail mucin).** Mucin contains allantoin, glycolic acid, glycoproteins and copper peptides. A 2013 publication on [PubMed](https://pubmed.ncbi.nlm.nih.gov/23914966/) showed measurable improvement in fine lines and skin smoothness over 12 weeks. The evidence base is modest but consistent. It works best as a hydration and repair layer, not as a miracle treatment.

**Niacinamide.** A K-beauty staple, often dosed at 5 to 10 percent. Effects on sebum, pores and pigmentation are well documented. The [niacinamide research review](/blog/is-niacinamide-safe-dermatology-research/) on our site covers the safety and efficacy data in depth, and the [niacinamide and vitamin C compatibility myth](/blog/niacinamide-vitamin-c-together-myth-debunked/) is fully debunked.

**Hyaluronic acid.** Layered in essences, ampoules and creams. Effective as a humectant when applied on damp skin and sealed in. Common mistakes are covered in our [hyaluronic acid mistakes](/blog/hyaluronic-acid-mistakes-everyone-makes/) article.
...
**Layer 3: Targeted treatment.** Pick one serum or ampoule for your dominant concern. Niacinamide 5 to 10 percent for pores and oil control. Centella for sensitization. Snail mucin for repair. Vitamin C derivative (ascorbyl glucoside or ethyl ascorbic acid) for radiance. Tranexamic acid 2 to 3 percent for stubborn pigmentation. Retinol 0.1 to 0.3 percent for aging, only at night, only after a tolerance ramp-up. See our [retinol beginner guide](/blog/retinol-beginners-guide-how-to-start/) for the protocol.
...
A 2021 review on [PubMed](https://pubmed.ncbi.nlm.nih.gov/33843150/) examined skincare overuse and concluded that beyond five to six topical products, irritation and allergic contact dermatitis rates rise sharply without proportional benefit. The [ANSM](https://ansm.sante.fr) consumer cosmetics database also reports a clear correlation between the number of fragranced products applied daily and the incidence of sensitization complaints.
...
**Sensitive skin.** Use the centella + panthenol + madecassoside trio. Avoid essential oils, fragrance, denatured alcohol. Cosmetic regulation in the EU (referenced on the [HAS](https://www.has-sante.fr) website) requires fragrance allergen disclosure on the label, so check the INCI for the 26 listed allergens.
...
For a deeper comparison of pharmacy moisturizers see [CeraVe vs Cetaphil](/blog/cerave-vs-cetaphil-which-moisturizer-actually-better/) and for the dry skin angle our [best moisturizer for dry skin](/blog/best-moisturizer-dry-skin-dermatologist-picks/) guide.
