---
title: "The Ordinary Complete Guide: Every Product Ranked and Reviewed"
description: "The Ordinary guide ranking every major product by formulation, evidence and skin-type fit. Best buys, biggest skips, conflicts to avoid and a routine builder."
date: 2026-05-18T07:11:00+02:00
author: "marc-severin"
category: "guides"
tags: ["the ordinary", "deciem", "skincare guide", "niacinamide", "retinol", "hyaluronic acid", "aha bha"]
keywords: "the ordinary guide, best the ordinary products, the ordinary review, the ordinary niacinamide, the ordinary retinol, the ordinary routine"
draft: false
image: "https://images.unsplash.com/photo-1620916566398-39f1143ab7be?w=1200&h=630&fit=crop&crop=center&q=80"
imageAlt: "Row of identical pharmacy-style serum bottles with minimalist labels on a clean white surface"
lang: "en"
lastReviewed: "2026-05-18"
reviewedBy: "SkinScore Research Team"
schemaFaq: true
speakableTerm: "the ordinary guide"
speakable: "The Ordinary is a DECIEM brand offering more than 60 single-ingredient cosmetic actives at low prices. The strongest products are Niacinamide 10 percent plus Zinc, Hyaluronic Acid 2 percent plus B5, Retinol 0.5 percent in Squalane, Granactive Retinoid 2 percent Emulsion, and the AHA 30 percent plus BHA 2 percent Peeling Solution. Avoid mixing retinoids with acids in the same session, keep your routine to two or three products, and choose by ingredient strength rather than price."
---
...
The catalog now exceeds 60 products. Most sit between 6 and 15 euros. The packaging is deliberately clinical: dropper bottles, INCI-style names, percentages on the label. This transparency is the brand's strongest asset and the reason the [American Academy of Dermatology](https://www.aad.org/public/everyday-care/skin-care-secrets/anti-aging/retinoid-retinol) consistently lists several Ordinary references as accessible entry points for evidence-based actives like retinol and niacinamide.
...
- **Oiliness and visible pores**: Niacinamide 10% + Zinc 1%. The most reliable product in the entire catalog. Sebum regulation is supported by multiple controlled trials indexed on [PubMed](https://pubmed.ncbi.nlm.nih.gov/16766489/).
- **Dehydration and tightness**: Hyaluronic Acid 2% + B5. Multi-weight HA blend with panthenol. Apply on damp skin only, as detailed in our [hyaluronic acid mistakes article](/blog/hyaluronic-acid-mistakes-everyone-makes/).
...
The **Mandelic Acid 10% + HA** is the most underrated product in the line. Mandelic acid has a larger molecule than glycolic, penetrates more slowly and suits darker skin tones and rosacea-prone skin better. Strong evidence base in [pubmed-indexed dermatology literature](https://pubmed.ncbi.nlm.nih.gov/30729662/).
...
Layer over hyaluronic acid on damp skin and follow with a moisturizer. Full protocol in our [retinol beginner guide](/blog/retinol-beginners-guide-how-to-start/). Retinoids are contraindicated during pregnancy: the [ANSM](https://ansm.sante.fr) and dermatology consensus advise against all topical retinoids while pregnant or breastfeeding.
...
A common myth says you cannot mix vitamin C with niacinamide. That is outdated. The pairing is fine and often beneficial, as we detail in our [niacinamide and vitamin C myth article](/blog/niacinamide-vitamin-c-together-myth-debunked/).
...
1. Stacking too many actives. Two or three is the ceiling.
2. Mixing retinoids and AHA/BHA in the same session.
3. Skipping sunscreen the day after an acid peel.
4. Applying HA on dry skin (it dehydrates).
5. Using fragranced creams over actives (often triggers irritation).
...
1. Cleanser
2. Niacinamide 10% + Zinc 1% (a few drops)
3. Light moisturizer (NMF + HA or pharmacy alternative)
4. Mineral or chemical SPF 30 to 50

**Morning, dry skin**:

1. Gentle cream cleanser
2. Hyaluronic Acid 2% + B5 on damp skin
3. Richer moisturizer with ceramides
4. SPF 30 to 50
...
3. Retinal 0.2% Emulsion or Retinol 0.2% in Squalane (start once weekly)
4. Moisturizer
...
Full sequencing principles in our [skincare routine order article](/blog/skincare-routine-order-morning-night/). The [Haute Autorite de Sante](https://www.has-sante.fr) and major dermatology bodies converge on the same logic: light to heavy, water-based before oil-based, actives in the middle, occlusive on top.
