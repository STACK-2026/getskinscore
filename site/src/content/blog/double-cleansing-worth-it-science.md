---
title: "Double cleansing: is it worth it? What the science says"
description: "Is double cleansing actually backed by science? A formulation-led guide to oil and water cleansers, who benefits, common mistakes, and what evidence shows."
date: 2026-05-27T08:00:00+02:00
author: "dr-sarah-chen"
category: "science"
tags: ["double cleansing", "oil cleanser", "k-beauty", "cleansing", "skin barrier", "surfactants"]
keywords: "double cleansing, oil cleanser, double cleanse worth it, second cleanse, oil based cleanser, water based cleanser, like dissolves like, surfactants skincare"
draft: false
image: "https://images.unsplash.com/photo-1611080626919-7cf5a9dbab5b?w=1200&h=630&fit=crop&crop=center&q=80"
imageAlt: "Two cleansing bottles, an oil based balm and a foaming gel, lined up on a clean bathroom shelf"
lang: "en"
lastReviewed: "2026-05-27"
reviewedBy: "Dr. Elena Voss"
schemaFaq: true
speakableTerm: "Double cleansing"
speakable: "Double cleansing is a two step routine that starts with an oil based cleanser to dissolve sunscreen, makeup and sebum, then follows with a water based cleanser to remove sweat, dust and water soluble residue. The method is supported by the surfactant chemistry principle of like dissolves like. It is most useful in the evening for people who wear sunscreen, long wear makeup, or have oily and acne prone skin. It is generally not needed in the morning, and a single gentle cleanser is enough for dry or sensitive skin if no SPF or makeup is being removed."
---
...
The world's top results on this topic come from brand pages (CeraVe, Bioderma, Caudalie) and lifestyle outlets (Forbes, Healthline, Today). None of them dig into the actual ingredient chemistry that decides whether your double cleanse is helping or hurting your skin. This guide does. Every product reference is graded on [SkinScore](/rankings), and the analysis follows the same [methodology](/methodology) we apply to ranked products.

## The quick answer (who needs double cleansing and who does not)

| Profile | Double cleanse worth it? | Frequency |
| --- | --- | --- |
| Wears SPF + makeup daily | Yes | Every evening |
| Oily or acne prone skin | Yes | Every evening |
| Wears SPF only, no makeup | Often yes | 4 to 6 evenings a week |
| Dry, sensitive, or eczema prone | Usually no | Avoid or 1 to 2 times a week max |
| Mature, normal skin, no makeup | Optional | 2 to 3 times a week |
| Morning routine (any profile) | No | Single cleanser or water rinse |
...
Sebum is roughly 25% squalene, 41% triglycerides, 16% wax esters, 12% free fatty acids, and the rest cholesterol and other lipids, according to data summarised in the [Journal of Investigative Dermatology](https://www.jidonline.org/). All of these molecules are non polar. Sunscreen filters such as octocrylene, avobenzone, homosalate and ethylhexyl methoxycinnamate are also lipophilic, designed to bind to the lipid layer of the stratum corneum to stay put under sweat and water. Silicones used in makeup (dimethicone, cyclopentasiloxane) are likewise non polar.

To dissolve this layer, you need an oil based solvent. That solvent is the first step of a double cleanse.

A water based foaming cleanser, in contrast, uses **surfactants**, molecules with one polar head and one non polar tail. The surfactant tails embed in oil droplets while the polar heads stay in water, forming micelles that lift residue away. Surfactants alone can clean a moderately soiled face, but they have to work harder, and "harder" usually means a higher surfactant concentration or a higher pH, both of which compromise the skin barrier over time. The British Association of Dermatologists notes in its [patient guidance on cleansing](https://www.bad.org.uk/) that high pH soap based cleansers are associated with reduced ceramide content and increased transepidermal water loss.
...
**No essential oils or fragrance.** Essential oils (lavender, citrus, ylang ylang, tea tree) added "for relaxation" are common allergens and irritants. The [American Contact Dermatitis Society](https://www.contactderm.org/) lists multiple essential oil components in its yearly allergen reviews. For a deeper read on this issue, see our [fragrance in skincare guide](/blog/fragrance-skincare-hidden-allergen/).
...
Reference picks that score well on these criteria include DHC Deep Cleansing Oil, Banila Co Clean It Zero Original, Heimish All Clean Balm, Then I Met You Living Cleansing Balm, and Clinique Take The Day Off Balm. Each is graded on its current formulation on [SkinScore rankings](/rankings).
...
**Surfactant family.** Look for **amino acid surfactants** (cocoyl glycinate, lauroyl glutamate, sodium methyl cocoyl taurate) or **glucoside surfactants** (decyl glucoside, coco glucoside, lauryl glucoside). Both are mild, biodegradable and well tolerated. The harsher families to avoid in a second cleanse include sodium lauryl sulphate (SLS) and ammonium lauryl sulphate (ALS). They are not "toxic," contrary to internet folklore, but they are demonstrably more drying. A 2010 review in the [International Journal of Cosmetic Science](https://onlinelibrary.wiley.com/journal/14682494) summarised the surfactant ladder from gentlest (amino acid) to harshest (sulphates) with a clear gradient of barrier disruption.

**pH between 5.0 and 5.5.** Skin surface pH sits between 4.7 and 5.7 according to multiple studies indexed on [PubMed](https://pubmed.ncbi.nlm.nih.gov/). A cleanser at pH 6 or above neutralises the acid mantle, increases activity of bacterial proteases, and disrupts ceramide synthesis. Few brands publish pH on the label, but you can find independent pH measurements for popular cleansers on community resources and on our [encyclopedia](/encyclopedia).
...
The exception: oily and acne prone skin that produces visible sebum overnight may benefit from a single low pH salicylic acid cleanser in the morning. That is a single cleanse, not a double. For full guidance on AM and PM choices, see our [skincare routine order guide](/blog/skincare-routine-order-morning-night/).
...
**Mistake 4: hot water rinse.** Anything above 40 degrees Celsius strips lipids and increases transepidermal water loss. Lukewarm only. The [American Academy of Dermatology daily care guidance](https://www.aad.org/public/everyday-care/skin-care-basics) explicitly recommends lukewarm water for cleansing.

**Mistake 5: double cleansing every day on dry or sensitive skin.** A weekly or twice weekly double cleanse is enough if you do not wear SPF or makeup. Daily double cleansing on already fragile skin produces tightness, redness, and worsens eczema or rosacea flares. The [British Association of Dermatologists](https://www.bad.org.uk/) and the NHS both caution against over cleansing in their patient guidance on dry skin and eczema.
...
- **Salicylic acid serums and benzoyl peroxide.** Both penetrate better through clean skin. Pore content (sebum and dead cells) blocks salicylic acid access into the follicle. For the full breakdown on these two ingredients, see [salicylic acid vs benzoyl peroxide for acne](/blog/salicylic-acid-vs-benzoyl-peroxide-acne/).
- **Retinol and retinoids.** Retinol breaks down in light and oxidises in the presence of residual oxidants. A clean, intact barrier improves tolerance. Read more in the [retinol beginners guide](/blog/retinol-beginners-guide-how-to-start/).
...
Yes. The technique does not change in pregnancy. Just verify that your oil cleanser does not contain salicylic acid or retinoids and that your second cleanser is free of fragrance and essential oils. For more on safe ingredients, see our [pregnancy safe skincare guide](/blog/pregnancy-safe-skincare-ingredient-guide/).
...
1. Ananthapadmanabhan, K.P. et al. (2004). "Cleansing without compromise: the impact of cleansers on the skin barrier and the technology of mild cleansing." *Dermatologic Therapy*, 17(s1), 16-25. [Wiley](https://onlinelibrary.wiley.com/journal/15291561)

2. Mukhopadhyay, P. (2011). "Cleansers and their role in various dermatological disorders." *Indian Journal of Dermatology*, 56(1), 2-6. [PubMed](https://pubmed.ncbi.nlm.nih.gov/21572783/)

3. Lambers, H. et al. (2006). "Natural skin surface pH is on average below 5, which is beneficial for its resident flora." *International Journal of Cosmetic Science*, 28(5), 359-370. [Wiley](https://onlinelibrary.wiley.com/journal/14682494)

4. Draelos, Z.D. (2018). "The science behind skin care: cleansers." *Journal of Drugs in Dermatology*. [JDD](https://jddonline.com/)

5. American Academy of Dermatology. "Face washing 101: dermatologists' tips for healthy skin." [AAD](https://www.aad.org/public/everyday-care/skin-care-basics)
...
**Related articles:**
- [Salicylic acid vs benzoyl peroxide for acne](/blog/salicylic-acid-vs-benzoyl-peroxide-acne/)
- [K-beauty routine explained: what science actually supports](/blog/k-beauty-routine-explained-science/)
- [Skincare routine order: morning and night](/blog/skincare-routine-order-morning-night/)
- [Fragrance in skincare: the hidden allergen](/blog/fragrance-skincare-hidden-allergen/)
- [Retinol for beginners: how to start without wrecking your skin](/blog/retinol-beginners-guide-how-to-start/)
