...
tags: ["ceramides", "skin barrier", "ceramide NP", "ceramide AP", "ceramide EOP", "ingredients"]
keywords: "ceramides NP AP EOP, skin barrier, MLR ratio, ceramide types, ceramide 1 2 3, ceramide ratio 3:1:1"
draft: false
image: "https://images.unsplash.com/photo-1556228720-195a672e8a03?w=1200&h=630&fit=crop&crop=center&q=80"
imageAlt: "White cream textures layered on a soft background symbolising skin barrier lipids"
lang: "en"
lastReviewed: "2026-06-30"
reviewedBy: "Dr. Elena Voss"
schemaFaq: true
speakableTerm: "ceramide ratio for skin barrier"
speakable: "Ceramides 1, 2 and 3 are the three best studied lipids in the human skin barrier. Ceramide 1, now called EOP, links the lipid layers together and is critical for waterproofing. Ceramide 2, or NS, is the most abundant ceramide in the stratum corneum. Ceramide 3, or NP, is the structural workhorse that gives the barrier its rigidity. A formula that lists ceramides without cholesterol and fatty acids is incomplete. The evidence based blend is roughly 3 parts ceramides, 1 part cholesterol, 1 part fatty acids, and this is what dermatologist favourite barrier creams copy."
---
...
A 2003 [PubMed study on ceramide composition in atopic dermatitis](https://pubmed.ncbi.nlm.nih.gov/14987251/) showed that ceramide 1 levels drop significantly in eczema prone skin, and the drop correlates with the severity of transepidermal water loss. Aging skin shows a similar but milder pattern. So replacing ceramide 1 on the surface matters, even though it is the least abundant of the three.
...
For where this active fits relative to other ingredients, our [skincare routine order morning and night guide](/blog/skincare-routine-order-morning-night/) shows how to layer barrier creams under sunscreen and over serums.
...
The European Academy of Dermatology and Venereology has published [educational materials on the epidermal barrier and atopic dermatitis](https://eadv.org/) that reference the same lipid ratio in the context of long term eczema management.
...
A humectant alongside, such as Glycerin or Sodium Hyaluronate, to support water binding while the lipid lamellae rebuild. Pairing a barrier cream with a [hyaluronic acid serum sized to the climate](/blog/hyaluronic-acid-molecular-weight-hmw-lmw-oligo/) is a good combo on dry days.
...
The [best moisturiser for dry skin picks](/blog/best-moisturizer-dry-skin-dermatologist-picks/) round up several creams that meet this bar across price ranges.
...
For sensitive or rosacea prone skin, avoid creams that list ceramides alongside fragrance, drying alcohols, or strong botanicals. The ceramides are gentle, the rest of the formula often is not. Our [rosacea skincare routine on what to avoid](/blog/rosacea-skincare-routine-what-to-avoid/) covers the trigger ingredients.
...
The fourth mistake is pairing a ceramide cream with strong actives layered too close. A retinol or AHA on top of a freshly applied ceramide cream blunts both. Apply actives first, wait, then seal with the barrier cream. Our [retinol beginners guide](/blog/retinol-beginners-guide-how-to-start/) explains the buffer technique.

ANSM, the French cosmetics safety agency, runs a [public cosmetics surveillance system](https://ansm.sante.fr/) where adverse reactions get logged. Ceramides do not show up as a meaningful issue, which is part of why dermatologists recommend them so freely.

## Frequently asked questions

**What is the difference between ceramide 1, 2 and 3?**
Ceramide 1 (now called EOP or EOS) carries a unique long chain that links adjacent lipid bilayers together, which is critical for waterproofing the barrier. Ceramide 2 (NS) is the most abundant ceramide by mass in healthy stratum corneum. Ceramide 3 (NP) is the most commonly used synthetic ceramide in cosmetic creams because it is the cheapest to manufacture and adds structural rigidity to the bilayer. A repair formula should ideally contain at least these three plus cholesterol and a free fatty acid.
